...
export const MenuItem = ({ i }) => {
  ...
  return (
    ...
    <a href="https://drive.google.com/file/d/1Ji57_vi2Va3ZZyQgUsyW9ml0r5aCJZ26/view?usp=sharing" rel="noopener noreferrer" target="_blank" style={{ textDecoration: "none" }}>
      <motion.li
        variants={variants}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
