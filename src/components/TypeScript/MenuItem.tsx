...
export const MenuItem = ({ i }) => {
  ...
  return (
    ...
    <a href="https://drive.google.com/file/d/1_m6bR-ewBPYGS19xGKmDZPaKpPW6gL9s/view?usp=sharing" rel="noopener noreferrer" target="_blank" style={{ textDecoration: "none" }}>
      <motion.li
        variants={variants}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
