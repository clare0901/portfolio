...
export const MenuItem = ({ i }) => {
  ...
  return (
    ...
    <a href="https://drive.google.com/file/d/1tCDpXfkRzBynwuEJnPtvJxPF82_rZKo2/view?usp=sharing" rel="noopener noreferrer" target="_blank" style={{ textDecoration: "none" }}>
      <motion.li
        variants={variants}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
