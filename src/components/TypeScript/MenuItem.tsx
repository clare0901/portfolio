...
export const MenuItem = ({ i }) => {
  ...
  return (
    ...
    <a href="https://drive.google.com/file/d/14k9FmbTz0TqeA9I4FPQg7vSTORDPqdNL/view?usp=sharing" rel="noopener noreferrer" target="_blank" style={{ textDecoration: "none" }}>
      <motion.li
        variants={variants}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
